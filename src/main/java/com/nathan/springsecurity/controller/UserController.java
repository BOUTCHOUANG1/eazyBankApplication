...
import com.nathan.springsecurity.constants.ApplicationConstants;
import com.nathan.springsecurity.model.Customer;
import com.nathan.springsecurity.model.LoginRequestDTO;
import com.nathan.springsecurity.model.LoginResponseDTO;
        ...
        try {
            ...
            if (savedcustomer.getId() > 0) {
                return ResponseEntity.status(HttpStatus.CREATED)
                        .body("Given UserDetails are successfully registered");
            } else {
